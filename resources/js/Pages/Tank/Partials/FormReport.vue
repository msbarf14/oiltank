...
watch(() => form.volume, value => {
    if(value > props.dataTank?.max_volume) alert('Volume Melebihi Batas Maksimal')
})
</script>
<template>
    <form @submit.prevent="submit" class="space-y-2">
        ...
        <div class="flex space-x-2">
            <div class="space-y-2">
                <label class="text-sm text-gray-600">Volume (KL). Max Volume <b>{{dataTank.max_volume}}</b> KL</label>
